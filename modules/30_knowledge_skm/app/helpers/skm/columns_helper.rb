module Skm::ColumnsHelper
  def available_parentable_skm_columns(column_id = nil)
    unless column_id.present?
      return available_skm_columns
    end

    all_columns = Skm::Column.enabled.parentable(column_id).multilingual
  ...
  def available_skm_columns
    all_columns = Skm::Column.enabled.multilingual
