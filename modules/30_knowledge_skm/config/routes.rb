Rails.application.routes.draw do
  scope :module => "skm" do
      ...
      match '/entry_templates/:template_id/switch_sequence(.:format)' => "entry_templates#switch_sequence"
      ...
      match '/api_entry_books/get_relations' => "api_entry_books#get_relations", :via => :get
