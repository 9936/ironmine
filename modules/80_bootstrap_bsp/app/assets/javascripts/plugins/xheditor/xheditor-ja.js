...
var xheditor=function(textarea,options)
{
	...
	this.html4Upload=function(fromfile,toUrl,callback)
	{
        ...
        if (token) $('<input name="authenticity_token" type="hidden" value="'+ token +'"/>').appendTo(jForm);
		this.remove=function()
		{
			if(_this!==null)
			{
