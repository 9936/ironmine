class Com::ConfigRelationMembersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(com_config_relation_members_url) }
      format.xml  { head :ok }
    end
  end
  ...
  def get_data
    com_config_relation_members_scope = Com::ConfigRelationMember.with_config_relation_type.with_config_relation_class
