module Irm::ReportsHelper
  ...
  def time_during_options
    ...
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_cury)}", "CURY"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_prevy)}", "PREVY"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_prev2y)}", "PREV2Y"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_ago2y)}", "AGO2Y"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_nexty)}", "NEXTY"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_prevcury)}", "PREVCURY"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_prevcur2y)}", "PREVCUR2Y"]
    grouped_options[t(:label_report_time_grouped_calendar_year)] << ["#{t(:label_report_time_curnexty)}", "CURNEXTY"]
    #日历季度
    grouped_options[t(:label_report_time_grouped_calendar_season)] = []
    grouped_options[t(:label_report_time_grouped_calendar_season)] << ["#{t(:label_report_time_currentq)}", "CURRENTQ"]
    grouped_options[t(:label_report_time_grouped_calendar_season)] << ["#{t(:label_report_time_prevq)}", "PREVQ"]
    grouped_options[t(:label_report_time_grouped_calendar_season)] << ["#{t(:label_report_time_nextq)}", "NEXTQ"]
    grouped_options[t(:label_report_time_grouped_calendar_season)] << ["#{t(:label_report_time_curprevq)}", "CURPREVQ"]
    grouped_options[t(:label_report_time_grouped_calendar_season)] << ["#{t(:label_report_time_curnextq)}", "CURNEXTQ"]
    grouped_options[t(:label_report_time_grouped_calendar_season)] << ["#{t(:label_report_time_curnext3q)}", "CURNEXT3Q"]
    #日历月
    grouped_options[t(:label_report_time_grouped_calendar_month)] = []
    grouped_options[t(:label_report_time_grouped_calendar_month)] << ["#{t(:label_report_time_last_month)}", "LASTMONTH"]
    grouped_options[t(:label_report_time_grouped_calendar_month)] << ["#{t(:label_report_time_current_month)}", "CURMONTH"]
    grouped_options[t(:label_report_time_grouped_calendar_month)] << ["#{t(:label_report_time_next_month)}", "NEXTMONTH"]
    grouped_options[t(:label_report_time_grouped_calendar_month)] << ["#{t(:label_report_time_last_this_month)}", "LASTTHISMONTH"]
    grouped_options[t(:label_report_time_grouped_calendar_month)] << ["#{t(:label_report_time_next_this_month)}", "NEXTTHISMONTH"]
    #日历星期
    grouped_options[t(:label_report_time_grouped_calendar_week)] = []
    grouped_options[t(:label_report_time_grouped_calendar_week)] << ["#{t(:label_report_time_last_week)}", "LASTWEEK"]
    grouped_options[t(:label_report_time_grouped_calendar_week)] << ["#{t(:label_report_time_current_week)}", "CURWEEK"]
    grouped_options[t(:label_report_time_grouped_calendar_week)] << ["#{t(:label_report_time_next_week)}", "NEXTWEEK"]
    #日
