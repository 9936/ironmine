...
class AddSessionFunctiongroupAndMenuEetiry < ActiveRecord::Migration
  def up
    irm_session_time_out= Irm::FunctionGroup.new(:zone_code=>'SYSTEM_SETTING',:code=>'SESSION_TIME_OUT',:controller=>'irm/session_settings',:action=>'index',:not_auto_mult=>true)
