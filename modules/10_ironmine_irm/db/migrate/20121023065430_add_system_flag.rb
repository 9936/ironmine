class AddSystemFlag < ActiveRecord::Migration
  def up
    add_column :irm_permissions, :system_flag, :string, :limit => 1, :default => 'N', :after => 'code', :null => false
    add_column :irm_functions, :system_flag, :string, :limit => 1, :default => 'N', :after => 'code', :null => false
    add_column :irm_function_groups, :system_flag, :string, :limit => 1, :default => 'N', :after => 'code', :null => false
  ...
  def down
    remove_column :irm_permissions, :system_flag
    remove_column :irm_functions, :system_flag
    remove_column :irm_function_groups, :system_flag
