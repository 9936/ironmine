        ...
        private
          def save_time_trigger
            if self.time_trigger_obj.present?
              ...
              time_trigger.source_id = self.id
              time_trigger.source_type = self.class.name
          ...
          def setup_time_trigger
            self.time_trigger_obj = Irm::TimeTrigger.query_source(self.id, self.class.name).first
          end
      end
