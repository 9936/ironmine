class Hli::IncidentRequestUncloseMonthDetail < Irm::ReportManager::ReportBase
  def data(params={})
    params||={}
    ...
    statis = statis.where("external_system.id IN (?)", external_system_id) if external_system_id.present?
