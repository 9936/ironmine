class Hli::PersonWorkloadReportNew < Irm::ReportManager::ReportBase
  def data(params={})
    params||={}
    ...
    statis = Icm::IncidentRequest.
        ...
        select("lv.meaning workload_type_name, iw.real_processing_time real_processing_time, iw.created_at workload_date").
        order("(#{Icm::IncidentRequest.table_name}.submitted_date) ASC, iw.created_at ASC")
    ...
    statis.each do |s|
      ...
      data[10] = s[:workload_date].strftime('%F %T')
      data[11] = s[:workload_type_name]
      data[12] = s[:real_processing_time]
