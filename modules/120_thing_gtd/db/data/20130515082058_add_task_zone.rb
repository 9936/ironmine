...
class AddTaskZone < ActiveRecord::Migration
  def up
    ...
    irm_function_group_zone_task.lookup_values_tls.build(:lookup_value_id=>irm_function_group_zone_task.id,:meaning=>'任务',:description=>'任务',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
