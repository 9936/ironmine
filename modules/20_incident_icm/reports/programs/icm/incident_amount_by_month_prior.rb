class Icm::IncidentAmountByMonthPrior < Irm::ReportManager::ReportBase
  def data(params={})
    #params={:year_from=>2012,:year_to=>2012,:month_from=>2,:month_to=>2}

    static_data= Icm::IncidentRequest.select("DATE_FORMAT(submitted_date,'%Y-%m')   months  ,priority_id,count(1) num").
