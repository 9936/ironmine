class Icm::IncidentConfigRelation < ActiveRecord::Base
  set_table_name :icm_incident_config_relations
  ...
  validates_uniqueness_of :incident_request_id,:scope => [:config_item_id]
