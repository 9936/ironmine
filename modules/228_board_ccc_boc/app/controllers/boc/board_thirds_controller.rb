...
class Boc::BoardThirdsController < ApplicationController
  def index
    ...
    # 001b000B2jQm9tAWWwr1jk类单数
    @month_need_create = []
    # 其他类单数
    @month_other_create = []
    # 001b000B2jQm9tAWWwr1jk类工时
    @month_need_workload = []
    # 其他类工时
    ...
    months.each do |m|
      ...
      @month_need_create << Icm::IncidentRequest.enabled.
          where("#{Icm::IncidentRequest.table_name}.request_type_code = '001b000B2jQm9tAWWwr1jk'").
      ...
      need_workload = Icm::IncidentJournal.
          ...
          where("(#{Icm::IncidentJournal.table_name}.reply_type = 'SUPPORTER_REPLY' or #{Icm::IncidentJournal.table_name}.reply_type = 'OTHER_REPLY') and iir.request_type_code = '001b000B2jQm9tAWWwr1jk'").
