class AddNdmImportExcelTmpTable < ActiveRecord::Migration
  def up
    create_table :ndm_tmp_dev_managements, :force => true do |t|
      ...
      t.text   "message"
      t.string "import_status", :limit => 1
    ...
    change_column :ndm_tmp_dev_managements, "id", :string, :limit => 22, :collate => "utf8_bin"
  end
