...
class Icm::IncidentRequest < ActiveRecord::Base
  ...
  validates_presence_of :title,:external_system_id,:requested_by,:submitted_by,:request_type_code,:incident_category_id,
                        :impact_range_id,:urgence_id,:priority_id,:request_type_code,:incident_status_id,:report_source_code
                        #:contact_number,:contact_id,:attribute1
  ...
  def self.send_email(template_code,incident_request)
