...
class Ccc::CenterQuestionProgressExport < Irm::ReportManager::ReportBase
  def data(params={})
    ...
    headers = [
        ...
        I18n.t(:label_icm_incident_request_customer_satisfy_comment),
        I18n.t(:label_icm_incident_request_out_time_flag),
        I18n.t(:label_icm_incident_request_out_time_type),
        I18n.t(:label_project_manager),
        I18n.t(:label_irm_organization_conscientious),
        I18n.t(:label_project_type),
        I18n.t(:label_pricing_type),
        I18n.t(:label_begin_date),
