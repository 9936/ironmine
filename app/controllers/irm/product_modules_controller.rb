class Irm::ProductModulesController < ApplicationController
  ...
  def get_data
    ...
    product_modules_scope = product_modules_scope.match_value("#{Irm::ProductModule.table_name}.product_short_name",params[:product_short_name])
    product_modules_scope = product_modules_scope.match_value("#{Irm::ProductModulesTl.table_name}.name",params[:name])    
