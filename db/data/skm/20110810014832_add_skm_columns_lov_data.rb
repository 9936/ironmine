...
class AddSkmColumnsLovData < ActiveRecord::Migration
  def self.up
    ...
    skm_column.list_of_values_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库栏目',:description=>'知识库栏目',
                                     :value_title => "栏目名", :desc_title => "描述")
    skm_column.list_of_values_tls.build(:language=>'en',:source_lang=>'en',:name=>'Skm Columns',:description=>'Skm Columns',
