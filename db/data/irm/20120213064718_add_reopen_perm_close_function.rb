...
class AddReopenPermCloseFunction < ActiveRecord::Migration
  def up
    icm_permanent_close_incident_request= Irm::Function.new(:function_group_code=>'INCIDENT_REQUEST',:code=>'PERMANENT_CLOSE_INCIDENT_REQUEST',:default_flag=>'N',:login_flag => 'N', :public_flag=>'N',:not_auto_mult=>true)
