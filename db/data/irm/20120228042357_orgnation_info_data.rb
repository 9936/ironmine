# -*- coding: utf-8 -*-
class OrgnationInfoData < ActiveRecord::Migration
  def up
    ...
    irm_organization_info= Irm::Function.new(:function_group_code=>'ORGANIZATION',:code=>'ORGANIZATION_INFO',:default_flag=>'N',:login_flag => 'N', :public_flag=>'N',:not_auto_mult=>true)
    ...
    menu_entiry_119= Irm::MenuEntry.new(:menu_code=>'ORGANIZATION_MANAGEMENT',:sub_menu_code=>nil,:sub_function_group_code=>'ORGANIZATION',:display_sequence=>30)
